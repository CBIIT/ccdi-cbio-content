...
cBioPortal is an [open-source](https://about.cbioportal.org/), web-based platform designed to explore cancer data from large studies. Users can select one or more dtasets and query by gene, mutation, cancer type, or participant and quickly visualize relationships, patterns, and trends in the data.
